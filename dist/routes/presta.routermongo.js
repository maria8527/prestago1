...
const user_no_shema_1 = __importDefault(require("../schemas-joi/user-no.shema"));
...
exports.prestaRouter.post("/mongo", validator_1.default.body(user_no_shema_1.default), (_req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
exports.prestaRouter.put("/mongo/:id", validator_1.default.body(user_no_shema_1.default), (_req, res) => __awaiter(void 0, void 0, void 0, function* () {
