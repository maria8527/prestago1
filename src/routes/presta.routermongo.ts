...
import usuarionoSchema from '../schemas-joi/user-no.shema';
...
prestaRouter.post("/mongo", validator.body(usuarionoSchema), async (_req: Request, res: Response) => {
    try {
...
prestaRouter.put("/mongo/:id", validator.body(usuarionoSchema), async (_req: Request, res: Response) => {
